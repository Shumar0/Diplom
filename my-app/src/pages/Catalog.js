            ...
            <div className="main">
                ...
                <div className="products" id="product-list">
                    {products.map(product => (
                        <div className="product-card" style={product.discount > 0 ? {
                                ...
                                <div className="right-product-block">
                                    ...
                                    <div className="delivery-block">
                                        <div className="delivery-icon">
                                            <svg className="icon-small" xmlns="http://www.w3.org/2000/svg"
                                                 width="20"
                                        ...
                                        {product.available ? (
                                                <p className="delivery-data">Delivery: {getNextDay()}</p>) :
                                    ...
                                    <div className="price-block">
                                        ...
                                        <div className="bonuses-block">
                                            <p className="bonuses-amount">+{(product.price / 100).toFixed(0)}</p>
                                            <p>bonuses</p>
                                        </div>
                                    </div>
                                    <button
                                        className={`add-to-cart ${!product.available ? 'out-of-stock' : ''}`}
                                        disabled={!product.available} onClick={() => addToCart(product)}
